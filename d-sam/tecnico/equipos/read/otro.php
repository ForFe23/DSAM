    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $nombleCliente = $row["NOMBRECLIENTE"];
                        echo "<a href='../perifericos/read/index?id_equipo=" . $row['ID'] . "&id_cliente=" . $idCliente . "&nombre_cliente=" . $nombleCliente . "' class='btn btn-primary btn-sm'> Perifericos </a>";
                        echo "<br><br>";
                        echo "<a href='../incidente/read/index?id_equipo=" . $row['ID'] . "&id_cliente=" . $idCliente . "' class='btn btn-primary btn-sm'> Incidentes </a>";
                        echo "</div>";
                        echo "</td>";
         ...
         onclick='mostrarVistaGeneral(this)'>Vista General</button>";
                        ...
                        echo "<td data-label='Cliente'>" . ($row["NOMBRECLIENTE"] ? $row["NOMBRECLIENTE"] : '-') . "</td>";
