...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($conn->query($sql) === TRUE) {
            echo '<script>alert("Equipo creado exitosamente."); window.location.href = "../../dashboard/index?idCliente=' . $idCliente . '";</script>';
        } else {
    ...
    ?>
    <a href="../../registrar/seleccion" class="btn btn-primary" type="button">Volver</a>
    <center>
