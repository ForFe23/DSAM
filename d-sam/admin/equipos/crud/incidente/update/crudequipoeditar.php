...
<head>
    ...
    <title>Actualizar Incidente</title>
    ...
    ?>
        ...
        <center>
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <input type="text" name="DetalleCliente" value="<?php echo $row['DETALLEINCIDENTE']; ?>" required list="DetalleClienteList" oninput="this.value = this.value.toUpperCase()">
