...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($conn->query($sql) === TRUE) {
            echo '<script>alert("Equipo creado exitosamente."); window.location.href = "../read/crudequiposid?idCliente=' . $idCliente . '";</script>';
        } else {
    ...
    $IdClienteOpcion = $_GET['idCliente'];
    ...
    ?>
    <a onclick="VolverHistorial(this)" class="btn btn-primary" style="color:white;">Volver</a>
    <center>
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div id="pantalla3" class="hidden">
                ...
                <select name="statusEquipo">
                    <option value="ACTIVO" disabled selected hidden>Selecciona un estado</option>
