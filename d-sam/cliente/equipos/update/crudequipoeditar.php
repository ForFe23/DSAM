        ...
        <center>
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div id="pantalla1">
                    ...
                    <input type="text" name="serieEquipo" value="<?php echo $row['SERIEEQUIPO']; ?>" oninput="this.value = this.value.toUpperCase()"><br>
                    <label for="activoEquipo">Activo del Equipo:</label>
                    <input type="text" required name="activoEquipo" value="<?php echo $row['ACTIVOEQUIPO']; ?>" oninput="this.value = this.value.toUpperCase()">
                    ...
                    <input type="text" name="nombreEquipo" value="<?php echo $row['NOMBREEQUIPO']; ?>" oninput="this.value = this.value.toUpperCase()"><br>
                ...
                <div id="pantalla2" class="hidden">
                    ...
                    <input type="text" name="ipEquipo" value="<?php echo $row['IPEQUIPO']; ?>" oninput="this.value = this.value.toUpperCase()"><br>
                ...
                <div id="pantalla4" class="hidden">
                    ...
                    <input type="text" name="nombreUsuario" value="<?php echo $row['NOMBREUSUARIO']; ?>" list="usuariosList" oninput="this.value = this.value.toUpperCase()">
