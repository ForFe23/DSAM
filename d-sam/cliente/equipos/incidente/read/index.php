...
<body>
    ...
    <a class="btn btn-primary" style="color: white;" onclick="goBack()">Volver</a>
    <table class='table'>
        <thead>
            <tr>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr>
                <td colspan='8'>AUN NO SE REGISTRAN INCIDENTES</td>
                <center><a href=' ../create/crearincidente?id_equipo=$idEquipo&id_cliente=$idCliente'>Crear Nuevo Incidente</a></center>
