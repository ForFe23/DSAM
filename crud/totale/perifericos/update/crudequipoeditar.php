...
<body>
    <a onclick="Historial(this)" class="btn btn-primary">
        ...
        <center>
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div id="pantalla1">
                    ...
                    <input type="text" name="serieEquipo" VALUE="<?php echo $row['SERIEMONITOR']; ?>" oninput="this.value = this.value.toUpperCase()">
                    <br>

                    <label for="ActividadMonitor">Activo monitor:</label>
                    <input type="text" name="ActividadMonitor" list="ActividadMonitorList" value="<?php echo $row['ACTIVOMONITOR']; ?>" oninput="this.value = this.value.toUpperCase()">
                ...
                <div id="pantalla2" class="hidden">
                    ...
                    <input type="text" name="ActividadTeclado" list="ActividadTecladoList" VALUE="<?php echo $row['ACTIVOTECLADO']; ?>" oninput="this.value = this.value.toUpperCase()">
                ...
                <div id="pantalla3" class="hidden">
                    ...
                    <input type="text" name="ActividadMouse" list="ActividadMouseList" VALUE="<?php echo $row['ACTIVOMOUSE']; ?>" oninput="this.value = this.value.toUpperCase()">
                ...
                <div id="pantalla4" class="hidden">
                    ...
                    <input type="text" name="ActividadTelefono" list="ActividadTelefonoList" VALUE="<?php echo $row['ACTIVOTELEFONO']; ?>" oninput="this.value = this.value.toUpperCase()">
