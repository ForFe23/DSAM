...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<a href='../update/crudequipoeditar?id_equipo=" . $idEquipo . "'>Editar</a><br>";
            echo "<a href='../delete/deleteperifericos?id_equipo=" . $idEquipo . "'>Eliminar</a>";
            echo "</td>";
        ...
        header("Location: ../create/crearperifericos?id_equipo=$idEquipo");
        exit();
    }
    ?>
    </tbody>
