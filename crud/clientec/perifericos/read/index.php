...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<a href='../UPDATE/crudEquipoEditar.php?id_equipo=" . $idEquipo . "'>Editar</a><br>";
            echo "<a href='../DELETE/DeletePerifericos.php?id_equipo=" . $idEquipo . "'>Eliminar</a>";
            echo "</td>";
        ...
        header("Location: ../CREATE/crearPerifericos.php?id_equipo=$idEquipo");
        exit();
    }
    ?>
    </tbody>
